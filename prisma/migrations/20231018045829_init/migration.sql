...
-- AddForeignKey
ALTER TABLE "ActividadesDiarias" ADD CONSTRAINT "ActividadesDiarias_doctorId_fkey" FOREIGN KEY ("doctorId") REFERENCES "Doctor"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
